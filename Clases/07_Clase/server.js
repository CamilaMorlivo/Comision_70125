const express = require('express') //es lo mismo que import express from 'express'
...
//callback -> funcion pasada por parametros
//get http://localhost:8080 /
app.get('/api/users', (peticion, respuesta) => {
    respuesta.send({data: users})
})

//peticion (request) es un obj
